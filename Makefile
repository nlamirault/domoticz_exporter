...
MAIN = github.com/nlamirault/domoticz_exporter
SRCS = $(shell git ls-files '*.go' | grep -v '^vendor/')
PKGS = $(shell glide novendor)
EXE = $(shell ls domoticz_exporter-${VERSION}_*)
...
gox: ## Make all binaries
	...
	$(GOX) $(GOX_ARGS) github.com/nlamirault/domoticz_exporter
